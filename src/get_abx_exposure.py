...
def build_infection_eps(df, group_col='infection_id'):
    ...
    df = df.sort_values([group_col, 'latest_collect_dt']).copy()
    ...
    episodes_df = (
        ...
        .agg(
            ...
            tfc_desc=('tfc_desc', unique_sorted_list),

            # microbiology content
            organism_bug=('organism_bug', first_non_null),

            site=('site_grouped', resolve_site_value),
            ...
            prophylaxis=('prophylaxis', first_non_null),
